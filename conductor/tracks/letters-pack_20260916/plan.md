...
- [ ] Task: Context docs resync — `tech-stack.md` (letters pack entry: content-only integration, per-stroke hop plan) + `product-guidelines.md` (stale "Numbers-pack guide" line → skins-era wording) — before implementation per workflow.md
...
- [ ] Task: Headless screenshot QA per letter — start/goal/direction + glyph legibility
