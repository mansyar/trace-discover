...
// Patterns sweep: traces all 9 pattern levels in one chain through the real
// app (menu -> pack grid -> level -> success -> next) and ends on the badge
// seal. Evidence for the patterns pack being completable end to end.
...
console.log(
  `cleared: ${save.completedLevels.filter((id) => id.startsWith('pattern-')).length}, badges: ${JSON.stringify(save.badges)}`,
);
