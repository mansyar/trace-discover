...
// Animals sweep: traces all 8 animal levels in one chain through the real app
// (menu -> pack grid -> level -> success -> next). Evidence for the animals
...
console.log(
  `cleared: ${save.completedLevels.filter((id) => id.startsWith('animal-')).length}, badges: ${JSON.stringify(save.badges)}`,
);
