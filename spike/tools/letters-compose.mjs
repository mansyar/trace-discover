...
// "1 2 3" card). Reads spike/abc/clean, writes spike/abc/out.
// usage (cwd spike): node tools/letters-compose.mjs
...
const ABC = path.resolve(HERE, '..', 'abc');
...
for (const job of jobs) {
  ...
  console.log(`ok abc/out/${job.out}`);
}
await browser.close();
